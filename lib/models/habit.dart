  ...
  static List<Habit> fetchAll() {
    return [
      ...
      Habit(
        ...
        [0, 1, 2, 3, 4],
        [
          HabitDate(DateTime(2022, 3, 1), "Completed"),
          HabitDate(DateTime(2022, 3, 2), "Completed"),
          HabitDate(DateTime(2022, 3, 3), "Completed"),
          HabitDate(DateTime(2022, 3, 4), "Break"),
          HabitDate(DateTime(2022, 3, 5), "Completed"),
          HabitDate(DateTime(2022, 3, 6), "Uncompleted"),
          HabitDate(DateTime(2022, 3, 7), "Completed"),
          HabitDate(DateTime(2022, 3, 8), "Completed"),
        ],
        false,
      ),
    ];
